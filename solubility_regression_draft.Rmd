...
```
The performance of the random forest model is substantially better than the linear model. The RMSE of 0.861 is less than half the solubility's standard deviation of 2.09. The random forest explains much more of the variability of the solubility with an R^2 value of 0.830. Anecdotally, in this configuration and on this dataset, the random forest execution time is similar to that of the linear model.
...
linear_result_plot <- ggplot(lm_result$test_results, aes(x = prediction, y = solubility)) +
  ...
  labs(title = "Lienear model solubility vs prediction")

rf_result_plot <- ggplot(rf_result$test_results, aes(x = prediction, y = solubility)) +
  geom_jitter(alpha = alpha, width = 0.1) +
  geom_smooth(se = FALSE) +
  labs(title = "Random forest model solubility vs prediction")

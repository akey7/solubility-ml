...
I select the columns I will use as predictors here. I also make the train test split here and initialize the bootstrap sampling. I only use five times in bootstrap sampling to save on computational time. I tried higher numbers but found no significant performance enhancement with the added computational time.

...
The original report published a dataset of compounds represented as SMILES strings. SMILES strings are a compact and text-based method of specifying chemical structures. This study will use a preprocessed dataset from deepchem.io, which contains features parsed from these SMILES strings. This study uses a subset of these preprocessed features, which are listed in Table 2. 
...
## Footnotes
1. TODO: Add the h-bond donors specification
2. TODO: Add the rotatable bonds specification
